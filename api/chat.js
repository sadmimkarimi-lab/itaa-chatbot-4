...
14) تولید هرگونه محتوای سیاسی، تحلیلی، موافق یا مخالف حکومت‌ها، احزاب، جریان‌ها، انتخابات و به‌طور خاص مرتبط با جمهوری اسلامی ایران و نظام سیاسی
    ممنوع است. در این موارد فقط بنویس: «در این زمینه نمی‌توانم محتوا تولید کنم.»
...
16) اگر کاربر درخواستی نامناسب، غیراخلاقی، سیاسی یا خلاف ارزش‌های انسانی مطرح کرد:
...
export default async function handler(req, res) {
  ...
  if (blockedByKeyword || blockedByPhrase) {
    return res.status(200).json({
      ok: true,
      answer:
        "در این زمینه نمی‌توانم محتوا یا پاسخ تولید کنم. اگر سوال دیگری در حوزه‌های سالم، آموزشی و مفید داری با خوشحالی کمک می‌کنم.",
    });
  }
